...
class APIConfig(BaseSettings):
    ...
    model_single_2class: str = "model_single_2class.pth"
    model_single_4class: str = "model_single_4class.pth"
    ...
    def get_model_path(self, electrode_setup: str, classification_task: str) -> Path:
        ...
        :param str electrode_setup: Electrode setup ("single" or "8channel").
        :param str classification_task: Classification task ("2class" or "4class").
        :return: Full path to model checkpoint.
        :rtype: Path
        """
        model_key = f"model_{electrode_setup}_{classification_task}"
