...
class ModelManager:
    ...
    Models available:
    - single_2class: Single-channel (Fp1), binary classification
    - single_4class: Single-channel (Fp1), 4-class classification
    ...
    def select_model(
        self,
        electrode_setup: Literal["single", "8channel"],
        ...
        :param Literal["single", "8channel"] electrode_setup: Electrode configuration.
    ...
    @staticmethod
    def get_channel_name(electrode_setup: Literal["single", "8channel"]) -> str:
        """
        Map electrode_setup to channel parameter for preprocessing.

        :param Literal["single", "8channel"] electrode_setup: Electrode configuration.
        :return: Channel name for preprocessing ("Fp1" or "all").
        :rtype: str
        """
        return "Fp1" if electrode_setup == "single" else "all"  # "all" = channel name for preprocessing
